...
async def long_solve_hash(input_hash, alg):
    await asyncio.sleep(random.randrange(8, 16))
    return f'password({alg}({input_hash[:8]}...))'
...
def main():
    print(identify_hashes('1111111122222222'))
    print(identify_hashes('11111111222222223333333344444444'))
    print(asyncio.run(long_solve_hash('1111111122222222', 'DES(Oracle)')))
